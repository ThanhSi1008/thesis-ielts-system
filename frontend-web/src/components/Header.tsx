    ...
    <header className="bg-white shadow-sm border-b border-gray-100 sticky top-0 z-50">
      <div className="container mx-auto max-w-screen-xl px-4 py-4 flex justify-between items-center">
        ...
        <nav className="hidden md:flex gap-8 font-medium items-center">
          ...
          <Link href="/grammar" className="hover:text-primary transition-colors">
            Grammar
          </Link>
          <Link href="/pronunciation" className="hover:text-primary transition-colors">
            Pronunciation
          </Link>
      ...
      {isMenuOpen && (
        <div className="md:hidden border-t border-gray-100 bg-white p-4 space-y-4 shadow-lg absolute w-full left-0">
           <Link href="/vocabulary" className="block py-2 font-medium" onClick={() => setIsMenuOpen(false)}>Vocabulary</Link>
           <Link href="/grammar" className="block py-2 font-medium" onClick={() => setIsMenuOpen(false)}>Grammar</Link>
           <Link href="/pronunciation" className="block py-2 font-medium" onClick={() => setIsMenuOpen(false)}>Pronunciation</Link>
