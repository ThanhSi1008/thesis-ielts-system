...
export interface MatchingFeaturesGroup {
...
export function MatchingFeaturesGroup({
  group,
  answers,
  onAnswer,
  submitted,
  ...
  return (
    <div className="mb-8 font-sans">
      ...
      <p className="text-[13px] text-gray-600 mb-6 leading-relaxed">
        {group.instruction || 'Match each statement with the correct feature/researcher.'}
      </p>
      ...
      {/* List of Researchers/Features Box */}
      {options.length > 0 && (
        <div className="mb-8 overflow-hidden border border-gray-300 rounded-lg shadow-sm max-w-sm">
          <div className="bg-gray-50 border-b border-gray-300 px-4 py-3">
            <h4 className="text-[12px] font-bold text-gray-600 uppercase tracking-widest leading-none">
              {group.type === 'matching_features' ? 'List of Researchers' : 'Options'}
            </h4>
          </div>
