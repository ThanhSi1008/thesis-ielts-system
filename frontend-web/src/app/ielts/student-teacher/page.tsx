...
export default function StudentTeacherHubPage() {
  const { user } = useAuth();
        ...
        <div className="flex gap-6 mt-2">
          ...
          <main className="flex-1 min-w-0 bg-white rounded-2xl shadow-sm overflow-hidden flex flex-col">
            <div className="px-8 flex-1">
              ...
              <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-blue-600 to-indigo-700 p-8 text-white mt-8 mb-8 pb-12 shadow-lg w-full">
                <div className="relative z-10 flex w-full h-full pb-0 pt-2 lg:pt-0 gap-x-8 items-center lg:items-end justify-between min-h-[120px]">
                  <div>
                    <h1 className="text-3xl font-extrabold tracking-tight mb-2">Student & Teacher Connect</h1>
                    <p className="text-blue-100 max-w-xl text-base opacity-90 leading-relaxed">
              ...
              {/* Tabs */}
              <div className="flex items-center gap-8 border-b-2 border-gray-100 px-4">
                <button
                  onClick={() => setActiveTab("student")}
                  className={`relative py-4 text-base font-bold flex items-center gap-2 transition-colors ${activeTab === "student" ? "text-primary" : "text-gray-400 hover:text-gray-700"}`}
                >
                ...
                <button
                  ...
                  className={`relative py-4 text-base font-bold flex items-center gap-2 transition-colors ${activeTab === "teacher" ? "text-primary" : "text-gray-400 hover:text-gray-700"}`}
                >
                    ...
                    <div className="w-full lg:w-2/3">
                      ...
                      {loading ? (
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          {teachers.map((link) => (
                            <div key={link.id} className="relative group bg-white border border-gray-200 rounded-2xl p-5 hover:border-primary/50 hover:shadow-md transition-all">
                               <button 
