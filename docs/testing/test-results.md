...
> **Sinh tự động:** 2026-05-18T21:06:04.438Z — Tác giả: Auto (Jest).
...
|---|---|---|---|---|---:|---|---|
| TC01 | Invalid | TC01_01 | firstName rỗng → 400 Bad Request (IsNotEmpty) | Pass | 24 | Auto (Jest) | 2026-05-18 |
| TC01 | Invalid | TC01_02 | email sai định dạng → 400 "Invalid email format" | Pass | 5 | Auto (Jest) | 2026-05-18 |
| TC01 | Invalid | TC01_03 | password < 6 ký tự → 400 "Password must be at least 6 characters" | Pass | 2 | Auto (Jest) | 2026-05-18 |
| TC01 | Invalid | TC01_04 | email đã tồn tại (Prisma P2002) → 400 "Email already exists" | Pass | 58 | Auto (Jest) | 2026-05-18 |
| TC01 | Valid | TC01_05 | payload hợp lệ → 201, trả SafeUser (không có password) | Pass | 52 | Auto (Jest) | 2026-05-18 |
| TC01 | Valid | TC01_06 | password được lưu dưới dạng bcrypt hash, không phải plaintext | Pass | 101 | Auto (Jest) | 2026-05-18 |
| TC01 | Valid | TC01_07 | tạo user thành công kéo theo tạo Deck "Default" cho Vocab Lab | Pass | 54 | Auto (Jest) | 2026-05-18 |
| TC01 | Valid | TC01_08 | không truyền role → mặc định "STUDENT"; truyền role hợp lệ (TEACHER) → tôn trọng giá trị | Pass | 97 | Auto (Jest) | 2026-05-18 |
| TC01 | Valid | TC01_09 | truyền role ADMIN → 400 (vai trò không được phép tự gán) | Pass | 1 | Auto (Jest) | 2026-05-18 |
| TC02 | Invalid | TC02_01 | email đúng + password sai → 401 "Invalid credentials" | Pass | 64 | Auto (Jest) | 2026-05-18 |
| TC02 | Invalid | TC02_02 | email không tồn tại + password đúng → 401 | Pass | 3 | Auto (Jest) | 2026-05-18 |
| TC02 | Invalid | TC02_03 | cả email và password đều sai → 401 | Pass | 2 | Auto (Jest) | 2026-05-18 |
| TC02 | Invalid | TC02_04 | payload thiếu password → 401 (passport-local từ chối) | Pass | 1 | Auto (Jest) | 2026-05-18 |
| TC02 | Valid | TC02_05 | email + password đúng → 200, trả { access_token, user }, JWT payload chứa { sub, email, role } | Pass | 54 | Auto (Jest) | 2026-05-18 |
| TC03 | Invalid | TC03_01 | body rỗng → 400 (MinLength 1) | Pass | 16 | Auto (Jest) | 2026-05-18 |
| TC03 | Invalid | TC03_02 | body quá dài (> 10000 ký tự) → 400 | Pass | 2 | Auto (Jest) | 2026-05-18 |
| TC03 | Invalid | TC03_03 | type không thuộc enum PostType → 400 | Pass | 1 | Auto (Jest) | 2026-05-18 |
| TC03 | Invalid | TC03_04 | không có JWT → 401 | Pass | 2 | Auto (Jest) | 2026-05-18 |
| TC03 | Valid | TC03_05 | tạo post valid → 201, trả author info, kích hoạt gamification.onEvent với XP=5 | Pass | 2 | Auto (Jest) | 2026-05-18 |
| TC03 | Valid | TC03_06 | tạo post kèm tags + imageUrls → service nhận đúng payload | Pass | 1 | Auto (Jest) | 2026-05-18 |
| TC03 | Valid | TC03_07 | list posts (không query) → 200, gọi prisma.post.findMany với where.isHidden=false | Pass | 2 | Auto (Jest) | 2026-05-18 |
| TC03 | Valid | TC03_08 | like lần đầu → 201, trả { liked: true }, increment likeCount | Pass | 3 | Auto (Jest) | 2026-05-18 |
| TC03 | Valid | TC03_09 | like trên post đã like → unlike, trả { liked: false } | Pass | 1 | Auto (Jest) | 2026-05-18 |
| TC03 | Valid | TC03_10 | like post không tồn tại → 404 Not Found | Pass | 1 | Auto (Jest) | 2026-05-18 |
| TC03 | Valid | TC03_11 | list posts với query limit dạng string số → 400 (DTO @IsInt không có @Type → strict) | Pass | 2 | Auto (Jest) | 2026-05-18 |
| TC05 | Invalid | TC05_01 | không có JWT → 401 | Pass | 24 | Auto (Jest) | 2026-05-18 |
| TC05 | Invalid | TC05_02 | GET /unread-count không có JWT → 401 | Pass | 2 | Auto (Jest) | 2026-05-18 |
| TC05 | Invalid | TC05_03 | DELETE /:id không có JWT → 401 | Pass | 2 | Auto (Jest) | 2026-05-18 |
| TC05 | Valid | TC05_04 | GET /notifications → 200, trả danh sách + tổng, sắp xếp desc theo createdAt | Pass | 5 | Auto (Jest) | 2026-05-18 |
| TC05 | Valid | TC05_05 | GET /notifications phân trang đúng page=2 → skip=20 | Pass | 3 | Auto (Jest) | 2026-05-18 |
| TC05 | Valid | TC05_06 | PATCH /:id/read → 200, chỉ update notification thuộc về user (where: { id, userId }) | Pass | 2 | Auto (Jest) | 2026-05-18 |
| TC05 | Valid | TC05_07 | PATCH /:id/read trên notification của user khác → updateMany trả count: 0 (không lộ thông tin) | Pass | 2 | Auto (Jest) | 2026-05-18 |
| TC05 | Valid | TC05_08 | PATCH /read-all → mark hết notification chưa đọc của user | Pass | 1 | Auto (Jest) | 2026-05-18 |
| TC05 | Valid | TC05_09 | DELETE /:id → 200, xoá notification thuộc user | Pass | 3 | Auto (Jest) | 2026-05-18 |
| TC06 | Invalid | TC06_01 | không có JWT (JwtAuthGuard từ chối) → 401 | Pass | 24 | Auto (Jest) | 2026-05-18 |
| TC06 | Invalid | TC06_02 | email sai định dạng → 400 "Invalid email format" | Pass | 7 | Auto (Jest) | 2026-05-18 |
| TC06 | Invalid | TC06_03 | role không nằm trong enum (STUDENT/TEACHER/ADMIN) → 400 | Pass | 4 | Auto (Jest) | 2026-05-18 |
| TC06 | Invalid | TC06_04 | isActive không phải boolean → 400 | Pass | 3 | Auto (Jest) | 2026-05-18 |
| TC06 | Invalid | TC06_05 | firstName là số → 400 (IsString) | Pass | 2 | Auto (Jest) | 2026-05-18 |
| TC06 | Invalid | TC06_06 | gửi field lạ không thuộc UpdateUserDto → 400 (forbidNonWhitelisted) | Pass | 1 | Auto (Jest) | 2026-05-18 |
| TC06 | Valid | TC06_07 | cập nhật firstName hợp lệ → 200, prisma.user.update được gọi đúng id | Pass | 2 | Auto (Jest) | 2026-05-18 |
| TC06 | Valid | TC06_08 | cập nhật email mới hợp lệ → 200 | Pass | 2 | Auto (Jest) | 2026-05-18 |
| TC06 | Valid | TC06_09 | cập nhật email đã có người khác dùng (Prisma P2002) → 400 | Pass | 4 | Auto (Jest) | 2026-05-18 |
| TC06 | Valid | TC06_10 | cập nhật role = TEACHER → 200, lưu đúng giá trị | Pass | 2 | Auto (Jest) | 2026-05-18 |
| TC06 | Valid | TC06_11 | cập nhật isActive = false → 200, lưu boolean đúng | Pass | 3 | Auto (Jest) | 2026-05-18 |
| TC06 | Valid | TC06_12 | body rỗng (không field) → 200, prisma vẫn được gọi với data toàn undefined (no-op) | Pass | 2 | Auto (Jest) | 2026-05-18 |
| TC10 | — | TC10_01 | GET /sounds → 200, trả mảng (public, không yêu cầu JWT) | Pass | 15 | Auto (Jest) | 2026-05-18 |
...
| TC10 | — | TC10_04 | không có JWT → 401 | Pass | 7 | Auto (Jest) | 2026-05-18 |
| TC10 | — | TC10_05 | payload hợp lệ → 201, service.updateProgress được gọi với (userId, soundId, score) | Pass | 3 | Auto (Jest) | 2026-05-18 |
| TC10 | — | TC10_06 | user role = STUDENT → 403 (RolesGuard từ chối) | Pass | 3 | Auto (Jest) | 2026-05-18 |
| TC10 | — | TC10_07 | user role = ADMIN + payload đủ field (symbol, type, word) → 201, service.createSound được gọi | Pass | 2 | Auto (Jest) | 2026-05-18 |
| TC10 | — | TC10_08 | ADMIN nhưng thiếu field "word" → 400 (DTO IsString) | Pass | 1 | Auto (Jest) | 2026-05-18 |
| TC11 | Invalid | TC11_01 | GET /overview không có JWT → 401 | Pass | 14 | Auto (Jest) | 2026-05-18 |
| TC11 | Invalid | TC11_02 | GET /foundation không có JWT → 401 | Pass | 2 | Auto (Jest) | 2026-05-18 |
| TC11 | Valid | TC11_03 | GET /overview → 200, service.getOverviewStats(userId) được gọi | Pass | 2 | Auto (Jest) | 2026-05-18 |
| TC11 | Valid | TC11_04 | GET /foundation → 200, đúng userId | Pass | 2 | Auto (Jest) | 2026-05-18 |
| TC11 | Valid | TC11_05 | GET /basic → 200, đúng userId | Pass | 4 | Auto (Jest) | 2026-05-18 |
| TC11 | Valid | TC11_06 | GET /advanced → 200, đúng userId | Pass | 5 | Auto (Jest) | 2026-05-18 |
| TC11 | Valid | TC11_07 | GET /intensive → 200, đúng userId | Pass | 3 | Auto (Jest) | 2026-05-18 |
...
|---|---|---|---:|
| TC01_01 | firstName rỗng → 400 Bad Request (IsNotEmpty) | Pass | 24 |
...
| TC01_06 | password được lưu dưới dạng bcrypt hash, không phải plaintext | Pass | 101 |
| TC01_07 | tạo user thành công kéo theo tạo Deck "Default" cho Vocab Lab | Pass | 54 |
| TC01_08 | không truyền role → mặc định "STUDENT"; truyền role hợp lệ (TEACHER) → tôn trọng giá trị | Pass | 97 |
| TC01_09 | truyền role ADMIN → 400 (vai trò không được phép tự gán) | Pass | 1 |
...
| TC02_05 | email + password đúng → 200, trả { access_token, user }, JWT payload chứa { sub, email, role } | Pass | 54 |

### `modules/posts/tests/posts.spec.ts`

| TC | Mô tả | Trạng thái | Thời gian (ms) |
|---|---|---|---:|
| TC03_01 | body rỗng → 400 (MinLength 1) | Pass | 16 |
...
| TC03_06 | tạo post kèm tags + imageUrls → service nhận đúng payload | Pass | 1 |
| TC03_07 | list posts (không query) → 200, gọi prisma.post.findMany với where.isHidden=false | Pass | 2 |
| TC03_08 | like lần đầu → 201, trả { liked: true }, increment likeCount | Pass | 3 |
...
| TC | Mô tả | Trạng thái | Thời gian (ms) |
|---|---|---|---:|
| TC05_01 | không có JWT → 401 | Pass | 24 |
...
| TC | Mô tả | Trạng thái | Thời gian (ms) |
|---|---|---|---:|
| TC06_01 | không có JWT (JwtAuthGuard từ chối) → 401 | Pass | 24 |
...
| TC | Mô tả | Trạng thái | Thời gian (ms) |
|---|---|---|---:|
| TC10_01 | GET /sounds → 200, trả mảng (public, không yêu cầu JWT) | Pass | 15 |
...
| TC10_04 | không có JWT → 401 | Pass | 7 |
...
| TC | Mô tả | Trạng thái | Thời gian (ms) |
|---|---|---|---:|
| TC11_01 | GET /overview không có JWT → 401 | Pass | 14 |
...
| TC11_06 | GET /advanced → 200, đúng userId | Pass | 5 |
