...
> **Sinh tự động:** 2026-05-22T23:46:19.505Z — Tác giả: Auto (Jest).
...
|---|---|---|---|---|---:|---|---|
| — | — | — | should return the correct health status and fallback environment to development | Pass | 2 | Auto (Jest) | 2026-05-22 |
| — | — | — | should return the environment set in NODE_ENV | Pass | 1 | Auto (Jest) | 2026-05-22 |
| — | — | — | should return root metadata | Pass | 17 | Auto (Jest) | 2026-05-22 |
| — | — | — | should call appService.getHealth | Pass | 2 | Auto (Jest) | 2026-05-22 |
| — | — | — | should call $connect on onModuleInit | Pass | 45 | Auto (Jest) | 2026-05-22 |
| — | — | — | should call $disconnect on onModuleDestroy | Pass | 6 | Auto (Jest) | 2026-05-22 |
| — | — | — | TC_AUTH_03_01: refresh token hợp lệ → 201 { accessToken, refreshToken } | Pass | 93 | Auto (Jest) | 2026-05-22 |
| — | — | — | TC_AUTH_03_02: refresh token expired → 401 Unauthorized | Pass | 6 | Auto (Jest) | 2026-05-22 |
| — | — | — | TC_AUTH_03_03: refresh token bị tamper (signature sai) → 401 Unauthorized | Pass | 15 | Auto (Jest) | 2026-05-22 |
| — | — | — | TC_AUTH_04_01: currentPassword đúng → 201 + message "changed successfully" | Pass | 254 | Auto (Jest) | 2026-05-22 |
| — | — | — | TC_AUTH_04_02: currentPassword sai → 400 "Current password is incorrect" | Pass | 65 | Auto (Jest) | 2026-05-22 |
| — | — | — | TC_AUTH_04_03: user OAuth (password=null) → 400 "Google sign-in" | Pass | 5 | Auto (Jest) | 2026-05-22 |
| — | — | — | TC_AUTH_05_01: ID token hợp lệ, user mới → 201, tạo user + Deck "Default" | Pass | 6 | Auto (Jest) | 2026-05-22 |
| — | — | — | TC_AUTH_05_02: ID token hợp lệ, user đã tồn tại (googleId khớp) → 201 login bình thường | Pass | 4 | Auto (Jest) | 2026-05-22 |
| — | — | — | TC_AUTH_05_03: ID token audience sai → 401 "Invalid Google ID token" | Pass | 7 | Auto (Jest) | 2026-05-22 |
| — | — | — | TC_AUTH_05_04: thiếu field email trong payload → 400 | Pass | 2 | Auto (Jest) | 2026-05-22 |
| — | — | — | TC_EXAM_01: submit hợp lệ (WRITING) → 201, status SUBMITTED, publishGradingTask được gọi đúng 1 lần với đúng payload | Pass | 43 | Auto (Jest) | 2026-05-22 |
| — | — | — | TC_EXAM_02: submit session đã GRADED → 400 "Session already graded" | Pass | 13 | Auto (Jest) | 2026-05-22 |
| — | — | — | TC_EXAM_03: submit session thuộc user khác → 403 Access denied | Pass | 3 | Auto (Jest) | 2026-05-22 |
| — | — | — | TC_EXAM_04: quota AI_WRITING_GRADING vượt giới hạn (FREE tier) → 403 QUOTA_EXCEEDED | Pass | 6 | Auto (Jest) | 2026-05-22 |
| — | — | — | TC_EXAM_05: submit không có token → 401 Unauthorized | Pass | 12 | Auto (Jest) | 2026-05-22 |
| — | — | — | TC_EXAM_06: sessionId không tồn tại → 404 Not Found | Pass | 4 | Auto (Jest) | 2026-05-22 |
| — | — | — | saves card with stability > 0 and due > now | Pass | 12 | Auto (Jest) | 2026-05-22 |
| — | — | — | creates a FlashcardReview record | Pass | 3 | Auto (Jest) | 2026-05-22 |
| — | — | — | resets stability to ~0.4 (FSRS Again default) | Pass | 28 | Auto (Jest) | 2026-05-22 |
| — | — | — | schedules due within ~10 minutes for Again on new card | Pass | 4 | Auto (Jest) | 2026-05-22 |
| — | — | — | scheduledDays(Easy) >= scheduledDays(Good) | Pass | 19 | Auto (Jest) | 2026-05-22 |
| — | — | — | throws NotFoundException when deck.userId !== caller userId | Pass | 76 | Auto (Jest) | 2026-05-22 |
| — | — | — | throws NotFoundException when card does not exist | Pass | 5 | Auto (Jest) | 2026-05-22 |
| — | — | — | returns NEW cards and LEARNING/REVIEW/RELEARNING cards with due <= now | Pass | 14 | Auto (Jest) | 2026-05-22 |
| — | — | — | excludes review cards with due > now | Pass | 8 | Auto (Jest) | 2026-05-22 |
| — | — | — | throws NotFoundException when deck not found or not owned | Pass | 3 | Auto (Jest) | 2026-05-22 |
| — | — | — | getAllSounds - should read from Redis cache if available | Pass | 2 | Auto (Jest) | 2026-05-22 |
| — | — | — | getAllSounds - should query DB and write to cache if cache is empty | Pass | 3 | Auto (Jest) | 2026-05-22 |
| — | — | — | getSoundBySymbol - should return cached sound symbol if exists | Pass | 3 | Auto (Jest) | 2026-05-22 |
| — | — | — | getSoundBySymbol - should query DB and cache if cache miss | Pass | 2 | Auto (Jest) | 2026-05-22 |
| — | — | — | createSound - should save sound and invalidate cache | Pass | 1 | Auto (Jest) | 2026-05-22 |
| — | — | — | updateSound - should update sound and invalidate cache | Pass | 1 | Auto (Jest) | 2026-05-22 |
| — | — | — | deleteSound - should delete sound and invalidate cache | Pass | 1 | Auto (Jest) | 2026-05-22 |
| — | — | — | getUserProgress - should fetch user progress and join with all sounds | Pass | 7 | Auto (Jest) | 2026-05-22 |
| — | — | — | getUserStats - should compute sound mastery metrics | Pass | 6 | Auto (Jest) | 2026-05-22 |
| — | — | — | getWordProgress - should fetch example words and evaluate mastery statuses based on attempts | Pass | 4 | Auto (Jest) | 2026-05-22 |
| — | — | — | updateProgress - should upsert progress record, invalidate cache and award gamification XP | Pass | 2 | Auto (Jest) | 2026-05-22 |
| — | — | — | createPronunciationAttempt - should create progress record in PENDING state | Pass | 2 | Auto (Jest) | 2026-05-22 |
| — | — | — | updatePronunciationAttempt - should update details | Pass | 2 | Auto (Jest) | 2026-05-22 |
| — | — | — | getListeningParts - should retrieve list sorted by part number | Pass | 2 | Auto (Jest) | 2026-05-22 |
| — | — | — | getListeningPartDetail - should throw NotFoundException when part doesn't exist | Pass | 46 | Auto (Jest) | 2026-05-22 |
| — | — | — | submitListeningPart - should evaluate answers correctly across all formats and create session | Pass | 5 | Auto (Jest) | 2026-05-22 |
| — | — | — | submitListeningPart - should reward extra high-score XP if score >= 80% | Pass | 2 | Auto (Jest) | 2026-05-22 |
| — | — | — | getReadingParts - should retrieve list sorted by part number | Pass | 4 | Auto (Jest) | 2026-05-22 |
| — | — | — | getReadingPartDetail - should throw NotFoundException if not exists | Pass | 3 | Auto (Jest) | 2026-05-22 |
| — | — | — | submitReadingPart - should evaluate answers correctly and award reading achievements | Pass | 5 | Auto (Jest) | 2026-05-22 |
| — | — | — | getWritingPrompts - should return paginated list of prompts with best score mapping | Pass | 1 | Auto (Jest) | 2026-05-22 |
| — | — | — | getWritingPromptDetail - should fetch prompt details along with active session and history | Pass | 3 | Auto (Jest) | 2026-05-22 |
| — | — | — | createWritingSession - should return existing session if already in progress | Pass | 6 | Auto (Jest) | 2026-05-22 |
| — | — | — | createWritingSession - should create a new session if none is in progress | Pass | 1 | Auto (Jest) | 2026-05-22 |
| — | — | — | saveWritingDraft - should update draft for an active session | Pass | 1 | Auto (Jest) | 2026-05-22 |
| — | — | — | saveWritingDraft - should throw NotFoundException if session is not active or doesn't exist | Pass | 2 | Auto (Jest) | 2026-05-22 |
| — | — | — | submitWritingSession - should update status to GRADING and trigger AI RabbitMQ task | Pass | 6 | Auto (Jest) | 2026-05-22 |
| — | — | — | createSpeakingSession - should create new session or return in-progress one | Pass | 2 | Auto (Jest) | 2026-05-22 |
| — | — | — | submitSpeakingSession - should fail if no audio answers are provided | Pass | 3 | Auto (Jest) | 2026-05-22 |
| — | — | — | submitSpeakingSession - should submit speaking answers and publish AI task | Pass | 7 | Auto (Jest) | 2026-05-22 |
| — | — | — | getStatistics - should aggregate correct scores over sessions | Pass | 1 | Auto (Jest) | 2026-05-22 |
| — | — | — | getHistoryDetail - should retrieve listening session detail and enforce ownership | Pass | 1 | Auto (Jest) | 2026-05-22 |
| — | — | — | getHistoryDetail - should throw NotFoundException on wrong ownership | Pass | 0 | Auto (Jest) | 2026-05-22 |
| — | — | — | TC_SUB_01: vnp_SecureHash sai secret → RspCode "97" (Fail checksum) | Pass | 13 | Auto (Jest) | 2026-05-22 |
| — | — | — | TC_SUB_02: IPN success (ResponseCode=00, HMAC đúng) → payment status "succeeded", subscription PREMIUM | Pass | 3 | Auto (Jest) | 2026-05-22 |
| — | — | — | TC_SUB_03: vnp_ResponseCode=24 (user cancel) → RspCode "00" non-success, payment.create không được gọi | Pass | 5 | Auto (Jest) | 2026-05-22 |
| — | — | — | TC_SUB_04: IPN replay (session đã xóa, payment đã tồn tại) → RspCode "02", không double-credit | Pass | 3 | Auto (Jest) | 2026-05-22 |
| — | — | — | TC_SUB_05: thiếu vnp_TxnRef → RspCode "99" (Missing txnRef) | Pass | 29 | Auto (Jest) | 2026-05-22 |
| — | — | — | should compile and resolve NotesModule dependencies | Pass | 6 | Auto (Jest) | 2026-05-22 |
| — | — | — | TC_SUB_06: startTrial() — user chưa trial → tạo subscription TRIALING, endDate ≈ now + 7 ngày | Pass | 0 | Auto (Jest) | 2026-05-22 |
| — | — | — | TC_SUB_07: startTrial() — trialUsed=true → throw BadRequestException "already used" | Pass | 43 | Auto (Jest) | 2026-05-22 |
| — | — | — | TC_SUB_08: cancelSubscription() — user FREE → throw BadRequestException | Pass | 1 | Auto (Jest) | 2026-05-22 |
| — | — | — | TC_SUB_09: cancelSubscription() — user PREMIUM → status CANCELED, paymentProvider.cancelSubscription gọi | Pass | 2 | Auto (Jest) | 2026-05-22 |
| — | — | — | TC_SUB_10: incrementUsage(AI_WRITING_GRADING) — còn quota → trả về true, count tăng | Pass | 2 | Auto (Jest) | 2026-05-22 |
| — | — | — | TC_SUB_11: incrementUsage(AI_WRITING_GRADING) — vượt quota → trả về false, count bị rollback | Pass | 1 | Auto (Jest) | 2026-05-22 |
| — | — | — | sets currentStreak to 1 and lastActiveDate to today | Pass | 2 | Auto (Jest) | 2026-05-22 |
| — | — | — | sets longestStreak to at least 1 on first activity | Pass | 1 | Auto (Jest) | 2026-05-22 |
| — | — | — | increments currentStreak by 1 when lastActiveDate was yesterday | Pass | 1 | Auto (Jest) | 2026-05-22 |
| — | — | — | updates longestStreak when new streak exceeds previous longest | Pass | 0 | Auto (Jest) | 2026-05-22 |
| — | — | — | resets currentStreak to 1 when lastActiveDate was 2+ days ago | Pass | 1 | Auto (Jest) | 2026-05-22 |
| — | — | — | does not decrement longestStreak on reset | Pass | 0 | Auto (Jest) | 2026-05-22 |
| — | — | — | returns profile without calling update when lastActiveDate is today | Pass | 4 | Auto (Jest) | 2026-05-22 |
| — | — | — | does not fire gamification events on same-day no-op | Pass | 2 | Auto (Jest) | 2026-05-22 |
| — | — | — | calls onEvent with achievementKeys containing XM_ON_FIRE when streak hits 7 | Pass | 2 | Auto (Jest) | 2026-05-22 |
| — | — | — | sends milestone notification when streak hits 7 (STREAK_MILESTONES includes 7) | Pass | 0 | Auto (Jest) | 2026-05-22 |
| — | — | — | passes XP proportional to new streak count (5 * newStreak) | Pass | 1 | Auto (Jest) | 2026-05-22 |
| — | — | — | returns null when profile does not exist | Pass | 0 | Auto (Jest) | 2026-05-22 |
| — | — | — | returns null and does not throw when Prisma throws | Pass | 3 | Auto (Jest) | 2026-05-22 |
| — | — | — | returns default values if profile does not exist | Pass | 2 | Auto (Jest) | 2026-05-22 |
| — | — | — | returns streak unmodified if lastActiveDate is null | Pass | 1 | Auto (Jest) | 2026-05-22 |
| — | — | — | returns streak unmodified if lastActiveDate is within 1 day (today) | Pass | 1 | Auto (Jest) | 2026-05-22 |
| — | — | — | returns streak unmodified if lastActiveDate is within 1 day (yesterday) | Pass | 4 | Auto (Jest) | 2026-05-22 |
| — | — | — | returns currentStreak = 0 if lastActiveDate is more than 1 day ago | Pass | 1 | Auto (Jest) | 2026-05-22 |
| — | — | — | should call service.getExamNotes with queries | Pass | 2 | Auto (Jest) | 2026-05-22 |
| — | — | — | should call service.upsertNote with dto data | Pass | 0 | Auto (Jest) | 2026-05-22 |
| — | — | — | should call service.deleteNote with param id and request user id | Pass | 2 | Auto (Jest) | 2026-05-22 |
| — | — | — | TC_RES_05: Không có JWT token → 401 Unauthorized | Pass | 4 | Auto (Jest) | 2026-05-22 |
| — | — | — | TC_RES_04: sessionId không tồn tại → 404 | Pass | 4 | Auto (Jest) | 2026-05-22 |
| — | — | — | TC_RES_03: sessionId thuộc user khác → 404 (không tiết lộ existence) | Pass | 2 | Auto (Jest) | 2026-05-22 |
| — | Valid | — | TC_RES_01: Session đang GRADING → 200 { status: "GRADING", result: null } | Pass | 11 | Auto (Jest) | 2026-05-22 |
| — | Valid | — | TC_RES_02: Session đã GRADED → 200, full result shape | Pass | 3 | Auto (Jest) | 2026-05-22 |
| — | Valid | — | TC_RES_06: Session GRADING_FAILED → 200 { status: "GRADING_FAILED", error: string } | Pass | 3 | Auto (Jest) | 2026-05-22 |
| — | — | — | TC_CB_01: callback với signature đúng → lưu result, session.status = GRADED, 200 OK | Pass | 39 | Auto (Jest) | 2026-05-22 |
| — | — | — | TC_CB_02: callback với signature sai → 401 Unauthorized, không ghi DB | Pass | 4 | Auto (Jest) | 2026-05-22 |
| — | — | — | TC_CB_03: callback cho session GRADING_FAILED → 200 idempotency, result không bị ghi đè | Pass | 7 | Auto (Jest) | 2026-05-22 |
| — | — | — | TC_CB_04: callback body thiếu totalScore và feedback → 400 Bad Request | Pass | 24 | Auto (Jest) | 2026-05-22 |
| — | — | — | should return completedSentences or empty array if progress not found | Pass | 7 | Auto (Jest) | 2026-05-22 |
| — | — | — | should return completedSentences if progress exists in DB | Pass | 1 | Auto (Jest) | 2026-05-22 |
| — | — | — | should create progress, award sentence XP, and NOT award lesson complete if video sentences not matched | Pass | 2 | Auto (Jest) | 2026-05-22 |
| — | — | — | should complete shadowing video and award lesson completion achievements when all sentences matched | Pass | 2 | Auto (Jest) | 2026-05-22 |
| — | — | — | should NOT trigger sentence XP if new completion count is not greater than existing count | Pass | 2 | Auto (Jest) | 2026-05-22 |
| — | — | — | should return mapped shadowing progress by lesson ID | Pass | 1 | Auto (Jest) | 2026-05-22 |
| — | — | — | creates XpLog with correct fields | Pass | 2 | Auto (Jest) | 2026-05-22 |
| — | — | — | updates IeltsProfile with new totalXp | Pass | 0 | Auto (Jest) | 2026-05-22 |
| — | — | — | does not crash when IeltsProfile does not exist | Pass | 2 | Auto (Jest) | 2026-05-22 |
| — | — | — | sends ACHIEVEMENT notification when level increases | Pass | 1 | Auto (Jest) | 2026-05-22 |
| — | — | — | does not send notification when level stays the same | Pass | 2 | Auto (Jest) | 2026-05-22 |
| — | — | — | skips UserAchievement.create when achievement already earned | Pass | 2 | Auto (Jest) | 2026-05-22 |
| — | — | — | skips XpLog.create entirely | Pass | 1 | Auto (Jest) | 2026-05-22 |
| — | — | — | still processes achievementKeys even when xp = 0 | Pass | 2 | Auto (Jest) | 2026-05-22 |
| — | — | — | grants achievement and sends notification when not yet earned | Pass | 1 | Auto (Jest) | 2026-05-22 |
| — | — | — | no-ops when achievement definition is missing in DB | Pass | 2 | Auto (Jest) | 2026-05-22 |
| — | — | — | should fetch exam notes ordered by questionNumber asc | Pass | 15 | Auto (Jest) | 2026-05-22 |
| — | — | — | should upsert a note successfully | Pass | 7 | Auto (Jest) | 2026-05-22 |
| — | — | — | should throw NotFoundException if note to delete does not exist | Pass | 9 | Auto (Jest) | 2026-05-22 |
| — | — | — | should delete the note if it exists | Pass | 1 | Auto (Jest) | 2026-05-22 |
| — | — | — | should allow access (return true) if no required roles are specified | Pass | 1 | Auto (Jest) | 2026-05-22 |
| — | — | — | should allow access (return true) if required roles list is empty | Pass | 1 | Auto (Jest) | 2026-05-22 |
| — | — | — | should throw ForbiddenException if user is not present in request | Pass | 3 | Auto (Jest) | 2026-05-22 |
| — | — | — | should throw ForbiddenException if user role does not match required roles | Pass | 6 | Auto (Jest) | 2026-05-22 |
| — | — | — | should allow access (return true) if user role matches required roles | Pass | 1 | Auto (Jest) | 2026-05-22 |
| — | — | — | should return completedSentences array and difficulty, or defaults if not found | Pass | 4 | Auto (Jest) | 2026-05-22 |
| — | — | — | should return completedSentences and difficulty from DB when row exists | Pass | 1 | Auto (Jest) | 2026-05-22 |
| — | — | — | should create new progress, award sentence XP, but NOT complete lesson if sentences < total | Pass | 1 | Auto (Jest) | 2026-05-22 |
| — | — | — | should transition lesson to complete, notify user, and award completion achievements | Pass | 1 | Auto (Jest) | 2026-05-22 |
| — | — | — | should NOT trigger completion notifications if lesson was already completed | Pass | 1 | Auto (Jest) | 2026-05-22 |
| — | — | — | should return mapped dictation progress by lesson ID | Pass | 0 | Auto (Jest) | 2026-05-22 |
| — | — | — | TC_SUB_12: subscription quá endDate + 3 ngày grace period → downgrade về FREE | Pass | 0 | Auto (Jest) | 2026-05-22 |
| — | — | — | TC_SUB_13: subscription trong grace period (endDate < now, < 3 ngày) → KHÔNG downgrade | Pass | 1 | Auto (Jest) | 2026-05-22 |
| — | — | — | TC_BOUND_01: score = 0 → 201 (lower boundary hợp lệ — @Min(0) pass) | Pass | 80 | Auto (Jest) | 2026-05-22 |
| — | — | — | TC_BOUND_02: score = 100 → 201 (upper boundary hợp lệ) | Pass | 6 | Auto (Jest) | 2026-05-22 |
| — | — | — | TC_BOUND_03: score = 101 → 201 (over max — HIỆN TẠI pass vì DTO thiếu @Max(100)) | Pass | 7 | Auto (Jest) | 2026-05-22 |
| — | — | — | TC_BOUND_04: score = -1 → 400 (under @Min(0) — ValidationPipe reject) | Pass | 4 | Auto (Jest) | 2026-05-22 |
| — | — | — | TC_BOUND_05: GET /foundation khi user chưa học gì → 200 { vocabulary.wordsLearned: 0 } — KHÔNG throw | Pass | 2 | Auto (Jest) | 2026-05-22 |
| — | — | — | TC_BOUND_06: POST /posts với body = "" → 400 (@MinLength(1) violation) | Pass | 7 | Auto (Jest) | 2026-05-22 |
| — | — | — | TC_BOUND_07: POST /posts với imageUrls = [] → 201 (mảng rỗng được phép) | Pass | 2 | Auto (Jest) | 2026-05-22 |
| — | — | — | TC_BOUND_08: POST /posts với imageUrls có 11 items → 201 (HIỆN TẠI pass vì thiếu @ArrayMaxSize(10)) | Pass | 3 | Auto (Jest) | 2026-05-22 |
| — | — | — | TC_JWT_01: payload hợp lệ → validate() trả { id, email, role } | Pass | 0 | Auto (Jest) | 2026-05-22 |
| — | — | — | TC_JWT_02: token ký bằng secret khác → passport từ chối → UnauthorizedException | Pass | 10 | Auto (Jest) | 2026-05-22 |
| — | — | — | TC_JWT_03: token expired (exp 1 giờ trước) → passport từ chối → UnauthorizedException | Pass | 1 | Auto (Jest) | 2026-05-22 |
| — | — | — | TC_JWT_04: payload thiếu field sub → id = undefined (TODO: nên throw UnauthorizedException) | Pass | 0 | Auto (Jest) | 2026-05-22 |
| — | — | — | TC_JWT_05: payload thiếu field role → role = undefined (TODO: nên throw UnauthorizedException) | Pass | 0 | Auto (Jest) | 2026-05-22 |
| — | — | — | TC_EDGE_01: ?page=0 → default về page 1 (ParseInt không reject) | Pass | 13 | Auto (Jest) | 2026-05-22 |
| — | — | — | TC_EDGE_02: ?page=-1 → 200 (ParseInt chấp nhận số âm, không có @Min) | Pass | 3 | Auto (Jest) | 2026-05-22 |
| — | — | — | TC_EDGE_03: ?limit=10000 → 200 (không có cap maxLimit trong controller) | Pass | 1 | Auto (Jest) | 2026-05-22 |
| — | — | — | TC_EDGE_04: ?cursor=not-a-valid-uuid → 200 (notifications không có cursor param) | Pass | 4 | Auto (Jest) | 2026-05-22 |
| — | — | — | TC_EDGE_05: (không truyền gì) → 200, DefaultValuePipe: page=1, limit=20 | Pass | 3 | Auto (Jest) | 2026-05-22 |
| — | — | — | TC_EDGE_06: ?limit=0 → 200 (ParseInt chấp nhận 0, không có @Min(1)) | Pass | 2 | Auto (Jest) | 2026-05-22 |
| — | — | — | TC_EDGE_07: user không có notification nào → 200 { notifications: [], total: 0 } (KHÔNG throw 404) | Pass | 2 | Auto (Jest) | 2026-05-22 |
| — | — | — | TC_EDGE_08: GET /api/v1/posts?cursor=<valid-uuid-nhưng-không-tồn-tại> → 200 { items: [] } | Pass | 6 | Auto (Jest) | 2026-05-22 |
| — | — | — | TC_SEC_01: PATCH /api/v1/vocab-lab/decks/:id với token userB → 404 | Pass | 13 | Auto (Jest) | 2026-05-22 |
| — | — | — | TC_SEC_02: DELETE /api/v1/vocab-lab/decks/:id với token userB → 404 | Pass | 2 | Auto (Jest) | 2026-05-22 |
| — | — | — | TC_SEC_03: GET /api/v1/vocab-lab/decks/:id/cards với token userB → 404 | Pass | 3 | Auto (Jest) | 2026-05-22 |
| — | — | — | TC_SEC_04: DELETE /api/v1/notes/:id với token userB → 404 | Pass | 2 | Auto (Jest) | 2026-05-22 |
| — | — | — | TC_SEC_05: PATCH /api/v1/notes/:id với token userB → 404 | Pass | 2 | Auto (Jest) | 2026-05-22 |
| — | — | — | TC_SEC_06: DELETE /api/v1/posts/:id với token userB (non-admin) → 403 | Pass | 1 | Auto (Jest) | 2026-05-22 |
| — | — | — | TC_SEC_07: PATCH /api/v1/posts/:id với token userB → 404 | Pass | 1 | Auto (Jest) | 2026-05-22 |
| — | — | — | TC_SEC_08: DELETE /api/v1/posts/:id với token adminUser → 200 [SECURITY GAP — admin bypass chưa implement, hiện trả 403] | Pass | 1 | Auto (Jest) | 2026-05-22 |
| TC01 | Invalid | TC01_01 | firstName rỗng → 400 Bad Request (IsNotEmpty) | Pass | 64 | Auto (Jest) | 2026-05-22 |
| TC01 | Invalid | TC01_02 | email sai định dạng → 400 "Invalid email format" | Pass | 5 | Auto (Jest) | 2026-05-22 |
| TC01 | Invalid | TC01_03 | password < 6 ký tự → 400 "Password must be at least 6 characters" | Pass | 3 | Auto (Jest) | 2026-05-22 |
| TC01 | Invalid | TC01_04 | email đã tồn tại (Prisma P2002) → 400 "Email already exists" | Pass | 81 | Auto (Jest) | 2026-05-22 |
| TC01 | Valid | TC01_05 | payload hợp lệ → 201, trả SafeUser (không có password) | Pass | 81 | Auto (Jest) | 2026-05-22 |
| TC01 | Valid | TC01_06 | password được lưu dưới dạng bcrypt hash, không phải plaintext | Pass | 164 | Auto (Jest) | 2026-05-22 |
| TC01 | Valid | TC01_07 | tạo user thành công kéo theo tạo Deck "Default" cho Vocab Lab | Pass | 97 | Auto (Jest) | 2026-05-22 |
| TC01 | Valid | TC01_08 | không truyền role → mặc định "STUDENT"; truyền role hợp lệ (TEACHER) → tôn trọng giá trị | Pass | 156 | Auto (Jest) | 2026-05-22 |
| TC01 | Valid | TC01_09 | truyền role ADMIN → 400 (vai trò không được phép tự gán) | Pass | 4 | Auto (Jest) | 2026-05-22 |
| TC02 | Invalid | TC02_01 | email đúng + password sai → 401 "Invalid credentials" | Pass | 122 | Auto (Jest) | 2026-05-22 |
| TC02 | Invalid | TC02_02 | email không tồn tại + password đúng → 401 | Pass | 4 | Auto (Jest) | 2026-05-22 |
| TC02 | Invalid | TC02_03 | cả email và password đều sai → 401 | Pass | 2 | Auto (Jest) | 2026-05-22 |
| TC02 | Invalid | TC02_04 | payload thiếu password → 401 (passport-local từ chối) | Pass | 3 | Auto (Jest) | 2026-05-22 |
| TC02 | Valid | TC02_05 | email + password đúng → 200, trả { access_token, user }, JWT payload chứa { sub, email, role } | Pass | 74 | Auto (Jest) | 2026-05-22 |
| TC03 | Invalid | TC03_01 | body rỗng → 400 (MinLength 1) | Pass | 11 | Auto (Jest) | 2026-05-22 |
| TC03 | Invalid | TC03_02 | body quá dài (> 10000 ký tự) → 400 | Pass | 3 | Auto (Jest) | 2026-05-22 |
| TC03 | Invalid | TC03_03 | type không thuộc enum PostType → 400 | Pass | 1 | Auto (Jest) | 2026-05-22 |
| TC03 | Invalid | TC03_04 | không có JWT → 401 | Pass | 5 | Auto (Jest) | 2026-05-22 |
| TC03 | Valid | TC03_05 | tạo post valid → 201, trả author info, kích hoạt gamification.onEvent với XP=5 | Pass | 4 | Auto (Jest) | 2026-05-22 |
| TC03 | Valid | TC03_06 | tạo post kèm tags + imageUrls → service nhận đúng payload | Pass | 13 | Auto (Jest) | 2026-05-22 |
| TC03 | Valid | TC03_07 | list posts (không query) → 200, gọi prisma.post.findMany với where.isHidden=false | Pass | 3 | Auto (Jest) | 2026-05-22 |
| TC03 | Valid | TC03_08 | like lần đầu → 201, trả { liked: true }, increment likeCount | Pass | 5 | Auto (Jest) | 2026-05-22 |
| TC03 | Valid | TC03_09 | like trên post đã like → unlike, trả { liked: false } | Pass | 80 | Auto (Jest) | 2026-05-22 |
| TC03 | Valid | TC03_10 | like post không tồn tại → 404 Not Found | Pass | 19 | Auto (Jest) | 2026-05-22 |
| TC03 | Valid | TC03_11 | list posts với query limit dạng string số → 400 (DTO @IsInt không có @Type → strict) | Pass | 5 | Auto (Jest) | 2026-05-22 |
| TC05 | Invalid | TC05_01 | không có JWT → 401 | Pass | 7 | Auto (Jest) | 2026-05-22 |
| TC05 | Invalid | TC05_02 | GET /unread-count không có JWT → 401 | Pass | 4 | Auto (Jest) | 2026-05-22 |
| TC05 | Invalid | TC05_03 | DELETE /:id không có JWT → 401 | Pass | 3 | Auto (Jest) | 2026-05-22 |
| TC05 | Valid | TC05_04 | GET /notifications → 200, trả danh sách + tổng, sắp xếp desc theo createdAt | Pass | 5 | Auto (Jest) | 2026-05-22 |
| TC05 | Valid | TC05_05 | GET /notifications phân trang đúng page=2 → skip=20 | Pass | 2 | Auto (Jest) | 2026-05-22 |
| TC05 | Valid | TC05_06 | PATCH /:id/read → 200, chỉ update notification thuộc về user (where: { id, userId }) | Pass | 3 | Auto (Jest) | 2026-05-22 |
| TC05 | Valid | TC05_07 | PATCH /:id/read trên notification của user khác → updateMany trả count: 0 (không lộ thông tin) | Pass | 2 | Auto (Jest) | 2026-05-22 |
| TC05 | Valid | TC05_08 | PATCH /read-all → mark hết notification chưa đọc của user | Pass | 3 | Auto (Jest) | 2026-05-22 |
| TC05 | Valid | TC05_09 | DELETE /:id → 200, xoá notification thuộc user | Pass | 5 | Auto (Jest) | 2026-05-22 |
| TC06 | Invalid | TC06_01 | không có JWT (JwtAuthGuard từ chối) → 401 | Pass | 92 | Auto (Jest) | 2026-05-22 |
| TC06 | Invalid | TC06_02 | email sai định dạng → 400 "Invalid email format" | Pass | 6 | Auto (Jest) | 2026-05-22 |
| TC06 | Invalid | TC06_03 | role không nằm trong enum (STUDENT/TEACHER/ADMIN) → 400 | Pass | 2 | Auto (Jest) | 2026-05-22 |
| TC06 | Invalid | TC06_04 | isActive không phải boolean → 400 | Pass | 6 | Auto (Jest) | 2026-05-22 |
| TC06 | Invalid | TC06_05 | firstName là số → 400 (IsString) | Pass | 4 | Auto (Jest) | 2026-05-22 |
| TC06 | Invalid | TC06_06 | gửi field lạ không thuộc UpdateUserDto → 400 (forbidNonWhitelisted) | Pass | 16 | Auto (Jest) | 2026-05-22 |
| TC06 | Valid | TC06_07 | cập nhật firstName hợp lệ → 200, prisma.user.update được gọi đúng id | Pass | 4 | Auto (Jest) | 2026-05-22 |
| TC06 | Valid | TC06_08 | cập nhật email mới hợp lệ → 200 | Pass | 5 | Auto (Jest) | 2026-05-22 |
| TC06 | Valid | TC06_09 | cập nhật email đã có người khác dùng (Prisma P2002) → 400 | Pass | 8 | Auto (Jest) | 2026-05-22 |
| TC06 | Valid | TC06_10 | cập nhật role = TEACHER → 200, lưu đúng giá trị | Pass | 44 | Auto (Jest) | 2026-05-22 |
| TC06 | Valid | TC06_11 | cập nhật isActive = false → 200, lưu boolean đúng | Pass | 36 | Auto (Jest) | 2026-05-22 |
| TC06 | Valid | TC06_12 | body rỗng (không field) → 200, prisma vẫn được gọi với data toàn undefined (no-op) | Pass | 2 | Auto (Jest) | 2026-05-22 |
| TC10 | — | TC10_01 | GET /sounds → 200, trả mảng (public, không yêu cầu JWT) | Pass | 60 | Auto (Jest) | 2026-05-22 |
| TC10 | — | TC10_02 | GET /sounds/:symbol khi không tồn tại → 404 "Pronunciation sound not found" | Pass | 5 | Auto (Jest) | 2026-05-22 |
| TC10 | — | TC10_03 | GET /sounds/:symbol có dữ liệu → 200, trả object sound | Pass | 4 | Auto (Jest) | 2026-05-22 |
| TC10 | — | TC10_04 | không có JWT → 401 | Pass | 15 | Auto (Jest) | 2026-05-22 |
| TC10 | — | TC10_05 | payload hợp lệ → 201, service.updateProgress được gọi với (userId, soundId, score) | Pass | 5 | Auto (Jest) | 2026-05-22 |
| TC10 | — | TC10_06 | user role = STUDENT → 403 (RolesGuard từ chối) | Pass | 4 | Auto (Jest) | 2026-05-22 |
| TC10 | — | TC10_07 | user role = ADMIN + payload đủ field (symbol, type, word) → 201, service.createSound được gọi | Pass | 6 | Auto (Jest) | 2026-05-22 |
| TC10 | — | TC10_08 | ADMIN nhưng thiếu field "word" → 400 (DTO IsString) | Pass | 2 | Auto (Jest) | 2026-05-22 |
| TC11 | Invalid | TC11_01 | GET /overview không có JWT → 401 | Pass | 16 | Auto (Jest) | 2026-05-22 |
| TC11 | Invalid | TC11_02 | GET /foundation không có JWT → 401 | Pass | 2 | Auto (Jest) | 2026-05-22 |
| TC11 | Valid | TC11_03 | GET /overview → 200, service.getOverviewStats(userId) được gọi | Pass | 2 | Auto (Jest) | 2026-05-22 |
| TC11 | Valid | TC11_04 | GET /foundation → 200, đúng userId | Pass | 3 | Auto (Jest) | 2026-05-22 |
| TC11 | Valid | TC11_05 | GET /basic → 200, đúng userId | Pass | 2 | Auto (Jest) | 2026-05-22 |
| TC11 | Valid | TC11_06 | GET /advanced → 200, đúng userId | Pass | 2 | Auto (Jest) | 2026-05-22 |
| TC11 | Valid | TC11_07 | GET /intensive → 200, đúng userId | Pass | 2 | Auto (Jest) | 2026-05-22 |
...
|---|---|---|---:|
| — | should return the correct health status and fallback environment to development | Pass | 2 |
| — | should return the environment set in NODE_ENV | Pass | 1 |

### `app.controller.spec.ts`

| TC | Mô tả | Trạng thái | Thời gian (ms) |
|---|---|---|---:|
| — | should return root metadata | Pass | 17 |
...
| TC | Mô tả | Trạng thái | Thời gian (ms) |
|---|---|---|---:|
| — | should call $connect on onModuleInit | Pass | 45 |
| — | should call $disconnect on onModuleDestroy | Pass | 6 |

### `modules/auth/tests/auth-extended.spec.ts`

| TC | Mô tả | Trạng thái | Thời gian (ms) |
|---|---|---|---:|
| — | TC_AUTH_03_01: refresh token hợp lệ → 201 { accessToken, refreshToken } | Pass | 93 |
| — | TC_AUTH_03_02: refresh token expired → 401 Unauthorized | Pass | 6 |
| — | TC_AUTH_03_03: refresh token bị tamper (signature sai) → 401 Unauthorized | Pass | 15 |
| — | TC_AUTH_04_01: currentPassword đúng → 201 + message "changed successfully" | Pass | 254 |
| — | TC_AUTH_04_02: currentPassword sai → 400 "Current password is incorrect" | Pass | 65 |
| — | TC_AUTH_04_03: user OAuth (password=null) → 400 "Google sign-in" | Pass | 5 |
| — | TC_AUTH_05_01: ID token hợp lệ, user mới → 201, tạo user + Deck "Default" | Pass | 6 |
...
| — | TC_AUTH_05_04: thiếu field email trong payload → 400 | Pass | 2 |

### `modules/exams/tests/exams-submit.spec.ts`

| TC | Mô tả | Trạng thái | Thời gian (ms) |
|---|---|---|---:|
| — | TC_EXAM_01: submit hợp lệ (WRITING) → 201, status SUBMITTED, publishGradingTask được gọi đúng 1 lần với đúng payload | Pass | 43 |
| — | TC_EXAM_02: submit session đã GRADED → 400 "Session already graded" | Pass | 13 |
| — | TC_EXAM_03: submit session thuộc user khác → 403 Access denied | Pass | 3 |
| — | TC_EXAM_04: quota AI_WRITING_GRADING vượt giới hạn (FREE tier) → 403 QUOTA_EXCEEDED | Pass | 6 |
| — | TC_EXAM_05: submit không có token → 401 Unauthorized | Pass | 12 |
...
| TC | Mô tả | Trạng thái | Thời gian (ms) |
|---|---|---|---:|
| — | saves card with stability > 0 and due > now | Pass | 12 |
| — | creates a FlashcardReview record | Pass | 3 |
| — | resets stability to ~0.4 (FSRS Again default) | Pass | 28 |
| — | schedules due within ~10 minutes for Again on new card | Pass | 4 |
| — | scheduledDays(Easy) >= scheduledDays(Good) | Pass | 19 |
| — | throws NotFoundException when deck.userId !== caller userId | Pass | 76 |
| — | throws NotFoundException when card does not exist | Pass | 5 |
| — | returns NEW cards and LEARNING/REVIEW/RELEARNING cards with due <= now | Pass | 14 |
| — | excludes review cards with due > now | Pass | 8 |
...
| TC | Mô tả | Trạng thái | Thời gian (ms) |
|---|---|---|---:|
| — | getAllSounds - should read from Redis cache if available | Pass | 2 |
| — | getAllSounds - should query DB and write to cache if cache is empty | Pass | 3 |
| — | getSoundBySymbol - should return cached sound symbol if exists | Pass | 3 |
...
| — | getUserProgress - should fetch user progress and join with all sounds | Pass | 7 |
| — | getUserStats - should compute sound mastery metrics | Pass | 6 |
| — | getWordProgress - should fetch example words and evaluate mastery statuses based on attempts | Pass | 4 |
...
| — | getListeningPartDetail - should throw NotFoundException when part doesn't exist | Pass | 46 |
| — | submitListeningPart - should evaluate answers correctly across all formats and create session | Pass | 5 |
| — | submitListeningPart - should reward extra high-score XP if score >= 80% | Pass | 2 |
...
| — | submitReadingPart - should evaluate answers correctly and award reading achievements | Pass | 5 |
...
| — | createWritingSession - should return existing session if already in progress | Pass | 6 |
...
| — | submitWritingSession - should update status to GRADING and trigger AI RabbitMQ task | Pass | 6 |
...
| — | submitSpeakingSession - should submit speaking answers and publish AI task | Pass | 7 |
...
| — | getHistoryDetail - should throw NotFoundException on wrong ownership | Pass | 0 |

### `modules/subscriptions/tests/subscriptions-webhook.spec.ts`

| TC | Mô tả | Trạng thái | Thời gian (ms) |
|---|---|---|---:|
| — | TC_SUB_01: vnp_SecureHash sai secret → RspCode "97" (Fail checksum) | Pass | 13 |
| — | TC_SUB_02: IPN success (ResponseCode=00, HMAC đúng) → payment status "succeeded", subscription PREMIUM | Pass | 3 |
| — | TC_SUB_03: vnp_ResponseCode=24 (user cancel) → RspCode "00" non-success, payment.create không được gọi | Pass | 5 |
| — | TC_SUB_04: IPN replay (session đã xóa, payment đã tồn tại) → RspCode "02", không double-credit | Pass | 3 |
| — | TC_SUB_05: thiếu vnp_TxnRef → RspCode "99" (Missing txnRef) | Pass | 29 |
...
| TC | Mô tả | Trạng thái | Thời gian (ms) |
|---|---|---|---:|
| — | TC_SUB_06: startTrial() — user chưa trial → tạo subscription TRIALING, endDate ≈ now + 7 ngày | Pass | 0 |
| — | TC_SUB_07: startTrial() — trialUsed=true → throw BadRequestException "already used" | Pass | 43 |
| — | TC_SUB_08: cancelSubscription() — user FREE → throw BadRequestException | Pass | 1 |
| — | TC_SUB_09: cancelSubscription() — user PREMIUM → status CANCELED, paymentProvider.cancelSubscription gọi | Pass | 2 |
| — | TC_SUB_10: incrementUsage(AI_WRITING_GRADING) — còn quota → trả về true, count tăng | Pass | 2 |
...
| — | updates longestStreak when new streak exceeds previous longest | Pass | 0 |
| — | resets currentStreak to 1 when lastActiveDate was 2+ days ago | Pass | 1 |
| — | does not decrement longestStreak on reset | Pass | 0 |
| — | returns profile without calling update when lastActiveDate is today | Pass | 4 |
| — | does not fire gamification events on same-day no-op | Pass | 2 |
...
| — | returns null when profile does not exist | Pass | 0 |
| — | returns null and does not throw when Prisma throws | Pass | 3 |
...
| — | should call service.upsertNote with dto data | Pass | 0 |
| — | should call service.deleteNote with param id and request user id | Pass | 2 |

### `modules/results/tests/results.spec.ts`

| TC | Mô tả | Trạng thái | Thời gian (ms) |
|---|---|---|---:|
| — | TC_RES_05: Không có JWT token → 401 Unauthorized | Pass | 4 |
| — | TC_RES_04: sessionId không tồn tại → 404 | Pass | 4 |
| — | TC_RES_03: sessionId thuộc user khác → 404 (không tiết lộ existence) | Pass | 2 |
| — | TC_RES_01: Session đang GRADING → 200 { status: "GRADING", result: null } | Pass | 11 |
...
| TC | Mô tả | Trạng thái | Thời gian (ms) |
|---|---|---|---:|
| — | TC_CB_01: callback với signature đúng → lưu result, session.status = GRADED, 200 OK | Pass | 39 |
| — | TC_CB_02: callback với signature sai → 401 Unauthorized, không ghi DB | Pass | 4 |
| — | TC_CB_03: callback cho session GRADING_FAILED → 200 idempotency, result không bị ghi đè | Pass | 7 |
| — | TC_CB_04: callback body thiếu totalScore và feedback → 400 Bad Request | Pass | 24 |
...
| — | should NOT trigger sentence XP if new completion count is not greater than existing count | Pass | 2 |
...
| — | does not send notification when level stays the same | Pass | 2 |
...
| — | no-ops when achievement definition is missing in DB | Pass | 2 |

### `modules/notes/tests/notes.service.spec.ts`

| TC | Mô tả | Trạng thái | Thời gian (ms) |
|---|---|---|---:|
| — | should fetch exam notes ordered by questionNumber asc | Pass | 15 |
| — | should upsert a note successfully | Pass | 7 |
...
| — | should throw ForbiddenException if user role does not match required roles | Pass | 6 |
...
| TC | Mô tả | Trạng thái | Thời gian (ms) |
|---|---|---|---:|
| — | should return completedSentences array and difficulty, or defaults if not found | Pass | 4 |
...
| TC | Mô tả | Trạng thái | Thời gian (ms) |
|---|---|---|---:|
| — | TC_BOUND_01: score = 0 → 201 (lower boundary hợp lệ — @Min(0) pass) | Pass | 80 |
| — | TC_BOUND_02: score = 100 → 201 (upper boundary hợp lệ) | Pass | 6 |
| — | TC_BOUND_03: score = 101 → 201 (over max — HIỆN TẠI pass vì DTO thiếu @Max(100)) | Pass | 7 |
| — | TC_BOUND_04: score = -1 → 400 (under @Min(0) — ValidationPipe reject) | Pass | 4 |
| — | TC_BOUND_05: GET /foundation khi user chưa học gì → 200 { vocabulary.wordsLearned: 0 } — KHÔNG throw | Pass | 2 |
| — | TC_BOUND_06: POST /posts với body = "" → 400 (@MinLength(1) violation) | Pass | 7 |
...
| TC | Mô tả | Trạng thái | Thời gian (ms) |
|---|---|---|---:|
| — | TC_EDGE_01: ?page=0 → default về page 1 (ParseInt không reject) | Pass | 13 |
...
| — | TC_EDGE_04: ?cursor=not-a-valid-uuid → 200 (notifications không có cursor param) | Pass | 4 |
| — | TC_EDGE_05: (không truyền gì) → 200, DefaultValuePipe: page=1, limit=20 | Pass | 3 |
| — | TC_EDGE_06: ?limit=0 → 200 (ParseInt chấp nhận 0, không có @Min(1)) | Pass | 2 |
| — | TC_EDGE_07: user không có notification nào → 200 { notifications: [], total: 0 } (KHÔNG throw 404) | Pass | 2 |
| — | TC_EDGE_08: GET /api/v1/posts?cursor=<valid-uuid-nhưng-không-tồn-tại> → 200 { items: [] } | Pass | 6 |
...
| TC | Mô tả | Trạng thái | Thời gian (ms) |
|---|---|---|---:|
| TC01_01 | firstName rỗng → 400 Bad Request (IsNotEmpty) | Pass | 64 |
| TC01_02 | email sai định dạng → 400 "Invalid email format" | Pass | 5 |
...
| TC01_05 | payload hợp lệ → 201, trả SafeUser (không có password) | Pass | 81 |
| TC01_06 | password được lưu dưới dạng bcrypt hash, không phải plaintext | Pass | 164 |
| TC01_07 | tạo user thành công kéo theo tạo Deck "Default" cho Vocab Lab | Pass | 97 |
| TC01_08 | không truyền role → mặc định "STUDENT"; truyền role hợp lệ (TEACHER) → tôn trọng giá trị | Pass | 156 |
| TC01_09 | truyền role ADMIN → 400 (vai trò không được phép tự gán) | Pass | 4 |

### `modules/auth/tests/login.spec.ts`

| TC | Mô tả | Trạng thái | Thời gian (ms) |
|---|---|---|---:|
| TC02_01 | email đúng + password sai → 401 "Invalid credentials" | Pass | 122 |
...
| TC03_06 | tạo post kèm tags + imageUrls → service nhận đúng payload | Pass | 13 |
...
| TC03_09 | like trên post đã like → unlike, trả { liked: false } | Pass | 80 |
...
| TC | Mô tả | Trạng thái | Thời gian (ms) |
|---|---|---|---:|
| TC05_01 | không có JWT → 401 | Pass | 7 |
...
| TC | Mô tả | Trạng thái | Thời gian (ms) |
|---|---|---|---:|
| TC06_01 | không có JWT (JwtAuthGuard từ chối) → 401 | Pass | 92 |
...
| TC06_04 | isActive không phải boolean → 400 | Pass | 6 |
| TC06_05 | firstName là số → 400 (IsString) | Pass | 4 |
| TC06_06 | gửi field lạ không thuộc UpdateUserDto → 400 (forbidNonWhitelisted) | Pass | 16 |
...
| TC06_10 | cập nhật role = TEACHER → 200, lưu đúng giá trị | Pass | 44 |
| TC06_11 | cập nhật isActive = false → 200, lưu boolean đúng | Pass | 36 |
| TC06_12 | body rỗng (không field) → 200, prisma vẫn được gọi với data toàn undefined (no-op) | Pass | 2 |

### `modules/pronunciation/tests/pronunciation.spec.ts`

| TC | Mô tả | Trạng thái | Thời gian (ms) |
|---|---|---|---:|
| TC10_01 | GET /sounds → 200, trả mảng (public, không yêu cầu JWT) | Pass | 60 |
...
| TC10_04 | không có JWT → 401 | Pass | 15 |
| TC10_05 | payload hợp lệ → 201, service.updateProgress được gọi với (userId, soundId, score) | Pass | 5 |
| TC10_06 | user role = STUDENT → 403 (RolesGuard từ chối) | Pass | 4 |
| TC10_07 | user role = ADMIN + payload đủ field (symbol, type, word) → 201, service.createSound được gọi | Pass | 6 |
...
| TC11_05 | GET /basic → 200, đúng userId | Pass | 2 |
