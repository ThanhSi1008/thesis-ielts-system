...
> **Sinh tự động:** 2026-05-16T04:40:49.036Z — Tác giả: Auto (Jest).
...
|---|---|---|---|---|---:|---|---|
| TC01 | Invalid | TC01_01 | firstName rỗng → 400 Bad Request (IsNotEmpty) | Pass | 15 | Auto (Jest) | 2026-05-16 |
| TC01 | Invalid | TC01_02 | email sai định dạng → 400 "Invalid email format" | Pass | 3 | Auto (Jest) | 2026-05-16 |
| TC01 | Invalid | TC01_03 | password < 6 ký tự → 400 "Password must be at least 6 characters" | Pass | 1 | Auto (Jest) | 2026-05-16 |
| TC01 | Invalid | TC01_04 | email đã tồn tại (Prisma P2002) → 400 "Email already exists" | Pass | 50 | Auto (Jest) | 2026-05-16 |
| TC01 | Valid | TC01_05 | payload hợp lệ → 201, trả SafeUser (không có password) | Pass | 48 | Auto (Jest) | 2026-05-16 |
...
| TC02 | Invalid | TC02_01 | email đúng + password sai → 401 "Invalid credentials" | Pass | 59 | Auto (Jest) | 2026-05-16 |
...
| TC03 | Invalid | TC03_02 | body quá dài (> 10000 ký tự) → 400 | Pass | 4 | Auto (Jest) | 2026-05-16 |
| TC03 | Invalid | TC03_03 | type không thuộc enum PostType → 400 | Pass | 1 | Auto (Jest) | 2026-05-16 |
| TC03 | Invalid | TC03_04 | không có JWT → 401 | Pass | 2 | Auto (Jest) | 2026-05-16 |
| TC03 | Valid | TC03_05 | tạo post valid → 201, trả author info, kích hoạt gamification.onEvent với XP=5 | Pass | 2 | Auto (Jest) | 2026-05-16 |
...
| TC03 | Valid | TC03_08 | like lần đầu → 201, trả { liked: true }, increment likeCount | Pass | 2 | Auto (Jest) | 2026-05-16 |
...
| TC03 | Valid | TC03_11 | list posts với query limit dạng string số → 400 (DTO @IsInt không có @Type → strict) | Pass | 1 | Auto (Jest) | 2026-05-16 |
| TC05 | Invalid | TC05_01 | không có JWT → 401 | Pass | 18 | Auto (Jest) | 2026-05-16 |
...
| TC05 | Valid | TC05_04 | GET /notifications → 200, trả danh sách + tổng, sắp xếp desc theo createdAt | Pass | 4 | Auto (Jest) | 2026-05-16 |
| TC05 | Valid | TC05_05 | GET /notifications phân trang đúng page=2 → skip=20 | Pass | 3 | Auto (Jest) | 2026-05-16 |
| TC05 | Valid | TC05_06 | PATCH /:id/read → 200, chỉ update notification thuộc về user (where: { id, userId }) | Pass | 3 | Auto (Jest) | 2026-05-16 |
| TC05 | Valid | TC05_07 | PATCH /:id/read trên notification của user khác → updateMany trả count: 0 (không lộ thông tin) | Pass | 3 | Auto (Jest) | 2026-05-16 |
| TC05 | Valid | TC05_08 | PATCH /read-all → mark hết notification chưa đọc của user | Pass | 2 | Auto (Jest) | 2026-05-16 |
| TC05 | Valid | TC05_09 | DELETE /:id → 200, xoá notification thuộc user | Pass | 6 | Auto (Jest) | 2026-05-16 |
| TC06 | Invalid | TC06_01 | không có JWT (JwtAuthGuard từ chối) → 401 | Pass | 21 | Auto (Jest) | 2026-05-16 |
...
| TC06 | Invalid | TC06_04 | isActive không phải boolean → 400 | Pass | 1 | Auto (Jest) | 2026-05-16 |
...
| TC06 | Valid | TC06_07 | cập nhật firstName hợp lệ → 200, prisma.user.update được gọi đúng id | Pass | 3 | Auto (Jest) | 2026-05-16 |
| TC06 | Valid | TC06_08 | cập nhật email mới hợp lệ → 200 | Pass | 3 | Auto (Jest) | 2026-05-16 |
| TC06 | Valid | TC06_09 | cập nhật email đã có người khác dùng (Prisma P2002) → 400 | Pass | 4 | Auto (Jest) | 2026-05-16 |
...
| TC10 | — | TC10_01 | GET /sounds → 200, trả mảng (public, không yêu cầu JWT) | Pass | 11 | Auto (Jest) | 2026-05-16 |
| TC10 | — | TC10_02 | GET /sounds/:symbol khi không tồn tại → 404 "Pronunciation sound not found" | Pass | 3 | Auto (Jest) | 2026-05-16 |
| TC10 | — | TC10_03 | GET /sounds/:symbol có dữ liệu → 200, trả object sound | Pass | 1 | Auto (Jest) | 2026-05-16 |
| TC10 | — | TC10_04 | không có JWT → 401 | Pass | 6 | Auto (Jest) | 2026-05-16 |
| TC10 | — | TC10_05 | payload hợp lệ → 201, service.updateProgress được gọi với (userId, soundId, score) | Pass | 3 | Auto (Jest) | 2026-05-16 |
...
| TC11 | Invalid | TC11_02 | GET /foundation không có JWT → 401 | Pass | 5 | Auto (Jest) | 2026-05-16 |
| TC11 | Valid | TC11_03 | GET /overview → 200, service.getOverviewStats(userId) được gọi | Pass | 5 | Auto (Jest) | 2026-05-16 |
| TC11 | Valid | TC11_04 | GET /foundation → 200, đúng userId | Pass | 3 | Auto (Jest) | 2026-05-16 |
| TC11 | Valid | TC11_05 | GET /basic → 200, đúng userId | Pass | 3 | Auto (Jest) | 2026-05-16 |
| TC11 | Valid | TC11_06 | GET /advanced → 200, đúng userId | Pass | 1 | Auto (Jest) | 2026-05-16 |
...
|---|---|---|---:|
| TC01_01 | firstName rỗng → 400 Bad Request (IsNotEmpty) | Pass | 15 |
| TC01_02 | email sai định dạng → 400 "Invalid email format" | Pass | 3 |
| TC01_03 | password < 6 ký tự → 400 "Password must be at least 6 characters" | Pass | 1 |
| TC01_04 | email đã tồn tại (Prisma P2002) → 400 "Email already exists" | Pass | 50 |
| TC01_05 | payload hợp lệ → 201, trả SafeUser (không có password) | Pass | 48 |
...
| TC | Mô tả | Trạng thái | Thời gian (ms) |
|---|---|---|---:|
| TC02_01 | email đúng + password sai → 401 "Invalid credentials" | Pass | 59 |
...
| TC03_08 | like lần đầu → 201, trả { liked: true }, increment likeCount | Pass | 2 |
| TC03_09 | like trên post đã like → unlike, trả { liked: false } | Pass | 1 |
| TC03_10 | like post không tồn tại → 404 Not Found | Pass | 1 |
| TC03_11 | list posts với query limit dạng string số → 400 (DTO @IsInt không có @Type → strict) | Pass | 1 |

### `modules/notifications/tests/notifications.spec.ts`

| TC | Mô tả | Trạng thái | Thời gian (ms) |
|---|---|---|---:|
| TC05_01 | không có JWT → 401 | Pass | 18 |
...
| TC | Mô tả | Trạng thái | Thời gian (ms) |
|---|---|---|---:|
| TC06_01 | không có JWT (JwtAuthGuard từ chối) → 401 | Pass | 21 |
...
| TC06_04 | isActive không phải boolean → 400 | Pass | 1 |
