# Sprint Planning & Task Backlog (Lịch sử Sprints) - IELTS Module
...
> **Method:** Agile/Scrum Sprint planning and backlog tracking  
...
| # | Task | Module | Status |
|---|---|---|---|
| C1 | **Fix Advanced Reading Result bug** | Advanced / Result | ✅ Done — `getReadingHistoryDetail(resultId)` |
...
| `GET /ielts/advanced/reading-history` | ✅ | ✅ | ✅ Done — C1 |
