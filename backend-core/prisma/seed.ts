...
async function main() {
  ...
  for (const book of vocabularyBooks) {
    ...
    console.log(
      `  ✓ Created: ${createdBook.name} (${book.units.length} units)`,
    );
  }
  ...
  const cambridge17Image =
    "https://res.cloudinary.com/dalaaegob/image/upload/v1773932448/ed06fa88-6d9c-4142-9c7e-3bcd8613f175.png";
  ...
  await upsertCambridgeExam({
    ...
    questions: {
      ...
      examiner: {
        ...
        role: "IELTS Examiner",
        avatarUrl:
          "https://res.cloudinary.com/dalaaegob/image/upload/v1774672658/jim-hopper_mawpyh.png",
      },
      parts: [
        {
          part_number: 1,
          ...
          questions: [
            {
              ...
              video:
                "https://res.cloudinary.com/dalaaegob/video/upload/v1774651103/1-1_cas2xq.mp4",
            },
            {
              text: "Did you enjoy studying history at school? Why, or why not?",
              video:
                "https://res.cloudinary.com/dalaaegob/video/upload/v1774651101/1-2_waawji.mp4",
            },
            {
              text: "How often do you watch TV programmes about history now? Why, or why not?",
              video:
                "https://res.cloudinary.com/dalaaegob/video/upload/v1774651100/1-3_cw4cz4.mp4",
            },
            {
              text: "What period in history would you like to learn more about? Why?",
              video:
                "https://res.cloudinary.com/dalaaegob/video/upload/v1774651099/1-4_vfoyzx.mp4",
            },
          ],
        },
        {
          ...
          video:
            "https://res.cloudinary.com/dalaaegob/video/upload/v1774667596/2-1_daeni9.mp4",
          video2:
            "https://res.cloudinary.com/dalaaegob/video/upload/v1774667596/2-2_caanop.mp4",
        },
        {
          part_number: 3,
          ...
          questions: [
            {
              ...
              video:
                "https://res.cloudinary.com/dalaaegob/video/upload/v1774651107/3-1_gjoj8d.mp4",
            },
            {
              text: "How well do people generally know their neighbours in your country?",
              video:
                "https://res.cloudinary.com/dalaaegob/video/upload/v1774651099/3-2_khqn7w.mp4",
            },
            {
              text: "How important do you think it is to have good neighbours?",
              video:
                "https://res.cloudinary.com/dalaaegob/video/upload/v1774651099/3-3_sambxo.mp4",
            },
            {
              text: "Which facilities are most important to people living in cities?",
              video:
                "https://res.cloudinary.com/dalaaegob/video/upload/v1774651105/3-4_jzlys0.mp4",
            },
            {
              text: "How does shopping in small local shops differ from shopping in large city centre shops?",
              video:
                "https://res.cloudinary.com/dalaaegob/video/upload/v1774651100/3-5_h7ckie.mp4",
            },
            {
              text: "Do you think that children should always go to the school nearest to where they live?",
              video:
                "https://res.cloudinary.com/dalaaegob/video/upload/v1774651100/3-6_j9dj5u.mp4",
            },
          ],
        },
      ],
  ...
  await upsertCambridgeExam({
    ...
    questions: {
      ...
      examiner: {
        ...
        role: "IELTS Examiner",
        avatarUrl:
          "https://res.cloudinary.com/dalaaegob/image/upload/v1774672202/amber-bennett_yhupu4.png",
      },
      parts: [
        {
          part_number: 1,
          ...
          questions: [
            {
              ...
              video:
                "https://res.cloudinary.com/dalaaegob/video/upload/v1774669864/1.1_zsrotd.mp4",
            },
            {
              text: "How much reading do you do for your work/studies? Why/Why not?",
              video:
                "https://res.cloudinary.com/dalaaegob/video/upload/v1774669860/1.2_ejqmb1.mp4",
            },
            {
              text: "What kinds of books do you read for pleasure? Why/Why not?",
              video:
                "https://res.cloudinary.com/dalaaegob/video/upload/v1774669860/1.3_gs36fs.mp4",
            },
            {
              text: "Do you prefer to read a newspaper or a magazine online, or to buy a copy? Why?",
              video:
                "https://res.cloudinary.com/dalaaegob/video/upload/v1774669862/1.4_xq5p4k.mp4",
            },
          ],
        },
        {
          ...
          video:
            "https://res.cloudinary.com/dalaaegob/video/upload/v1774669864/2.1_ckz0y8.mp4",
          video2:
            "https://res.cloudinary.com/dalaaegob/video/upload/v1774669863/2.2_cy5jf7.mp4",
        },
        {
          part_number: 3,
          part_type: "Part 3: Discussion Topics",
          ...
          questions: [
            {
              ...
              video:
                "https://res.cloudinary.com/dalaaegob/video/upload/v1774669868/3.1_hhezku.mp4",
            },
            {
              text: "Why can it be expensive to visit cities on holiday?",
              video:
                "https://res.cloudinary.com/dalaaegob/video/upload/v1774669861/3.2_ywkn6r.mp4",
            },
            {
              text: "Do you think it is better to visit cities alone or in a group with friends?",
              video:
                "https://res.cloudinary.com/dalaaegob/video/upload/v1774669861/3.3_agpays.mp4",
            },
            {
              text: "Why have cities increased in size in recent years?",
              video:
                "https://res.cloudinary.com/dalaaegob/video/upload/v1774669863/3.4_chcirv.mp4",
            },
            {
              text: "What are the challenges created by ever-growing cities?",
              video:
                "https://res.cloudinary.com/dalaaegob/video/upload/v1774669861/3.5_bakekj.mp4",
            },
            {
              text: "In what ways do you think cities of the future will be different to cities today?",
              video:
                "https://res.cloudinary.com/dalaaegob/video/upload/v1774669861/3.6_soujli.mp4",
            },
          ],
        },
      ],
  ...
  console.log("🏫 Seeding IELTS Basic Theory & Exercises...");
  await seedIeltsBasic(prisma);

  console.log("🎧 Seeding IELTS Advanced Listening Parts...");
