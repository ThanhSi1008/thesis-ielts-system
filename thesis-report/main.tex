...
\documentclass[a4paper]{extreport}   % bỏ 13pt ở đây
\usepackage[fontsize=13pt]{fontsize}           % thêm dòng này
% ===================================================
...
% Cấu hình ngăn chặn tràn lề (Overfull \hbox)
\emergencystretch 3em
\let\oldunderscore\_
\renewcommand{\_}{\oldunderscore\allowbreak}

% Cấu hình hiển thị tiêu đề hình vẽ/bảng biểu (cỡ chữ bằng cỡ chữ văn bản, nhãn in đậm)
\usepackage[font=normalsize,labelfont=bf]{caption}

% Giới hạn mục lục chỉ đưa đến nhóm tiểu mục thứ 3 (X.Y.Z)
...
% Cho phép ngắt dòng URL/DOI tại các ký tự chữ và số trong bibliography
...
% Style cho phần Phụ lục (không đánh số trang)
\fancypagestyle{appendixstyle}{
    ...
    \fancyfoot[C]{} % Không đánh số trang phần phụ lục
    \renewcommand{\headrulewidth}{0.5pt}
    \renewcommand{\footrulewidth}{0.5pt}
}
...
% Padding trái và phải của mỗi ô bằng nhau (mặc định LaTeX là 6pt nhưng khai báo tường minh
% để tránh package khác override; công thức \tbu dưới dùng \tabcolsep nên tự cập nhật theo)
