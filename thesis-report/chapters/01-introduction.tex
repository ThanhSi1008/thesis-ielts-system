...
\begin{itemize}
    ...
    \item Xây dựng hệ thống học và ôn từ vựng theo lộ trình, áp dụng thuật toán FSRS (Free Spaced Repetition Scheduler) nhằm tối ưu hóa khả năng ghi nhớ dài hạn.
...
\begin{itemize}
    ...
    \item Học từ vựng theo lộ trình được đề xuất; ôn tập bằng Flashcard với thuật toán Spaced Repetition (FSRS — Free Spaced Repetition Scheduler) phân loại thẻ theo mức độ ghi nhớ (Again/Hard/Good/Easy).
...
\begin{itemize}
    ...
    \item \textbf{Bảo mật tài khoản:} Áp dụng rate limiting (ThrottlerModule) để giới hạn số lượng request, ngăn chặn tấn công brute-force; mật khẩu được mã hóa bằng bcrypt với 10 vòng salt.
