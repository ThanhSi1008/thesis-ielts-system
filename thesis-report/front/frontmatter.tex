...
% Cột p{} "Nghĩa đầy đủ" chiếm phần còn lại sau STT + Từ viết tắt
% Cột p{} "Nghĩa đầy đủ" chiếm phần còn lại sau STT + Từ viết tắt
% Chia tỷ lệ các cột để tổng bằng 100\tbu (100% chiều rộng)
\setlength{\tbu}{\dimexpr(\linewidth - 6\tabcolsep - 4\arrayrulewidth)/100\relax}
\begin{longtable}{|>{\centering\arraybackslash}p{10\tbu}|p{20\tbu}|p{70\tbu}|}
    \hline
    ...
    \hline
    9 & FSRS    & Free Spaced Repetition Scheduler \\
    \hline
