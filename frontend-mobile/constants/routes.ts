...
export const ROUTES = {
  ...
  ieltsAdvancedSkillPartHistory: (skill: string, partId: string) =>
    `/ielts/advanced/${skill}/${partId}/history`,
  ieltsAdvancedSkillPartResult: (skill: string, partId: string, resultId: string) =>
    `/ielts/advanced/${skill}/${partId}/result/${resultId}`,
  ...
  ieltsAdvancedSpeakingResult: (sessionId: string) =>
    `/ielts/advanced/speaking/result/${sessionId}`,
  ...
  foundationVocabularyUnit: (bookId: string, unitId: string) =>
    `/ielts/foundation/vocabulary/${bookId}/${unitId}`,

  foundationGrammar: '/ielts/foundation/grammar',
  foundationGrammarBook: (bookSlug: string) => `/ielts/foundation/grammar/${bookSlug}`,
  foundationGrammarUnit: (bookSlug: string, unitId: string) =>
    `/ielts/foundation/grammar/${bookSlug}/${unitId}`,
  ...
  shadowingLesson: (lessonId: string, mode: 'shadowing' | 'dictation') =>
    `/shadowing/${lessonId}/${mode}`,
