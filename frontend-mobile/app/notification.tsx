...
export default function NotificationScreen() {
  ...
  const handleRead = async (id: string) => {
    ...
    try { await notifApi.markAsRead(id); } catch { /* silent */ }
  };
  ...
  const handleDelete = async (id: string) => {
    ...
    try { await notifApi.delete(id); } catch { /* silent */ }
  };
  ...
  const handleMarkAllRead = async () => {
    ...
    setUnreadCount(0);
    try { await notifApi.markAllAsRead(); } catch { /* silent */ }
  ...
  const renderEmpty = () => {
    ...
    return (
      <View style={styles.emptyWrap}>
        ...
        <Text style={styles.emptySubtitle}>You have no notifications right now.{'\n'}We'll notify you when something happens.</Text>
      </View>
    );
  };
    ...
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      {!user ? (
        <View style={styles.emptyWrap}>
          ...
          <Text style={styles.emptySubtitle}>Log in to receive updates about your progress, streaks, and more.</Text>
        </View>
      ) : loading ? (
        ...
        <FlatList
          ...
          refreshControl={<RefreshControl refreshing={refreshing} onRefresh={onRefresh} tintColor="#FFC600" />}
...
const styles = StyleSheet.create({
  ...
  eyebrow: { fontSize: 10, fontFamily: 'Farro-Bold', textTransform: 'uppercase', letterSpacing: 0.6, color: '#9ca3af' },
  headerTitle: { fontFamily: 'Farro-Bold', fontSize: 22, color: '#111', letterSpacing: -0.25, lineHeight: 26 },

  markAllBtn: {
    flexDirection: 'row', alignItems: 'center', gap: 5,
    backgroundColor: 'rgba(255,198,0,0.1)', paddingVertical: 7, paddingHorizontal: 12,
    borderRadius: 999, borderWidth: 1, borderColor: 'rgba(255,198,0,0.3)',
  },
  ...
  unreadBanner: {
    ...
    borderBottomWidth: 1, borderBottomColor: 'rgba(255,198,0,0.15)',
  },
  ...
  itemUnread: {
    borderLeftWidth: 3, borderLeftColor: '#FFC600',
  ...
  deleteBtn: {
    ...
    borderRadius: 8, backgroundColor: '#f9fafb', flexShrink: 0,
  },
  ...
  emptyTitle: { fontFamily: 'Farro-Bold', fontSize: 18, color: '#111', marginBottom: 8, textAlign: 'center' },
  emptySubtitle: { fontFamily: 'Farro-Regular', fontSize: 13, color: '#9ca3af', textAlign: 'center', lineHeight: 20 },
});
