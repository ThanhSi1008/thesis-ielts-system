          ...
          {activeView === 'teachers' && (
            <View style={styles.linkCard}>
              ...
              <Text style={styles.linkSub}>
                Ask your teacher for their user ID and enter it below.
              </Text>
          ...
          {activeView === 'students' ? (
            students.length === 0 ? (
              <EmptyState
                ...
                subtitle="Students who link to you will appear here."
              />
            ) : (
              <>
                  ...
                  return (
                    ...
                    >
                      ...
                      <View style={styles.personRight}>
                        <Badge
                          label={link.status || 'LINKED'}
                          color={statusColor[link.status] ?? COLORS.success}
                        />
            ...
            <EmptyState
              icon="👩‍🏫"
              title="No teachers linked"
              subtitle="Use the form above to link your teacher."
            />
          ) : (
            <>
