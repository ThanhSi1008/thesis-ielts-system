...
import { 
  ...
  Switch, Alert, ActivityIndicator, TextInput, KeyboardAvoidingView, Platform, RefreshControl 
} from 'react-native';
...
export default function ProfileScreen() {
    ...
    return (
      <SafeAreaView style={styles.safeArea} edges={['top']}>
        <View style={styles.guestContainer}>
          ...
          <Text style={styles.guestDesc}>Sign in to save your progress, sync across devices, and earn achievements.</Text>
  ...
  const renderStatsTab = () => {
    ...
    const progress = gamProfile && gamProfile.xpNeeded > 0 
                    ...
                    <View style={styles.achContent}>
                      ...
                      {!isEarned && ach.progress !== undefined && (
                        <View style={styles.achProgressBg}>
                          <View style={[styles.achProgressFill, { width: `${ach.conditionValue ? Math.min(100, Math.max(0, (ach.progress / ach.conditionValue) * 100)) : 0}%` }]} />
                        </View>
                      )}
                    </View>
      ...
      {user.googleId ? (
        <View style={[styles.card, { flexDirection: 'row', alignItems: 'center', gap: 16 }]}>
          ...
          <View style={{ flex: 1 }}>
            ...
            <Text style={styles.googleDesc}>Password management is handled by your Google account.</Text>
          </View>
        </View>
      ) : (
        <View style={styles.card}>
          ...
          <TouchableOpacity style={styles.outlineBtn} onPress={handleChangePassword} disabled={saving}>
            {saving ? <ActivityIndicator color={COLORS.primary} size="small" /> : <Text style={styles.outlineBtnText}>Update Password</Text>}
          </TouchableOpacity>
        </View>
      )}
