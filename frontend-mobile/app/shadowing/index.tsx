...
export default function ShadowingScreen() {
  ...
  const tabLessons = tab === 'my-videos' 
    ...
    <View style={styles.container}>
      ...
      <View style={[styles.header, { paddingTop: insets.top }]}>
        ...
        <View style={styles.modeToggle}>
          ...
          >
            <Ionicons name="volume-high" size={14} color={mode === 'shadowing' ? THEME.BLU : THEME.FG3} />
            <Text style={[styles.modeBtnText, mode === 'shadowing' && styles.modeBtnTextActive]}>Shadowing</Text>
          </TouchableOpacity>
          <TouchableOpacity 
            style={[styles.modeBtn, mode === 'dictation' && styles.modeBtnActive]} 
            onPress={() => setMode('dictation')}
          >
            <Ionicons name="pencil" size={14} color={mode === 'dictation' ? THEME.ORG : THEME.FG3} />
            <Text style={[styles.modeBtnText, mode === 'dictation' && styles.modeBtnTextActive]}>Dictation</Text>
          </TouchableOpacity>
        </View>

        {/* Sub-tabs */}
        <View style={styles.subTabs}>
          <TouchableOpacity style={[styles.subTab, tab === 'library' && styles.subTabActive]} onPress={() => setTab('library')}>
            <Text style={[styles.subTabText, tab === 'library' && styles.subTabTextActive]}>Library</Text>
          </TouchableOpacity>
          <TouchableOpacity style={[styles.subTab, tab === 'my-videos' && styles.subTabActive]} onPress={() => setTab('my-videos')}>
            <Text style={[styles.subTabText, tab === 'my-videos' && styles.subTabTextActive]}>My Videos</Text>
      ...
      <View style={styles.listWrap}>
        <Text style={styles.countText}>{filtered.length} of {tabLessons.length} lessons</Text>
...
const styles = StyleSheet.create({
  ...
  header: {
    ...
    borderBottomWidth: 1, borderBottomColor: THEME.BDR,
    zIndex: 20,
  },
  headerRow: {
  ...
  headerTitle: { fontFamily: 'Farro-Bold', fontSize: 21, color: THEME.FG1, letterSpacing: -0.25, lineHeight: 26 },
  searchBtn: {
  ...
  searchWrap: {
    flexDirection: 'row', alignItems: 'center', backgroundColor: THEME.WH,
    marginHorizontal: 16, marginBottom: 8, paddingHorizontal: 12, borderRadius: 12,
    borderWidth: 1, borderColor: THEME.BDR, height: 38,
  },
  searchInput: { flex: 1, fontFamily: 'Farro-Regular', fontSize: 13, color: THEME.FG1 },
  
  modeToggle: {
    flexDirection: 'row', marginHorizontal: 16, marginBottom: 8,
    backgroundColor: '#ebebeb', borderRadius: 11, padding: 3,
  },
  modeBtn: {
  ...
  subTabs: {
    flexDirection: 'row', marginHorizontal: 16, borderBottomWidth: 2, borderBottomColor: '#f0f0f0',
  },
  subTab: {
    paddingVertical: 7, paddingRight: 12, flexDirection: 'row', alignItems: 'center',
  ...
  chip: {
    ...
    borderWidth: 1, borderColor: THEME.BDR, backgroundColor: THEME.WH,
  },
  chipActive: {
    backgroundColor: THEME.P, borderColor: THEME.P,
    shadowColor: THEME.P, shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.5, shadowRadius: 8, elevation: 2,
  },
  ...
  countText: { fontFamily: 'Farro-Medium', fontSize: 11, color: THEME.FG3, paddingVertical: 7, fontWeight: '600' },
  ...
  thumbGlow: { position: 'absolute', top: -8, right: -8, width: 36, height: 36, borderRadius: 18, opacity: 0.3 },
  thumbProgBg: { position: 'absolute', bottom: 5, left: 5, right: 5, height: 3, backgroundColor: 'rgba(255,255,255,0.15)', borderRadius: 999 },
  thumbProgFill: { height: '100%', backgroundColor: THEME.P, borderRadius: 999 },
  
  metaWrap: { flex: 1, justifyContent: 'center' },
  lessonTitle: { fontFamily: 'Farro-Bold', fontSize: 13, color: THEME.FG1, lineHeight: 17, marginBottom: 3 },
  metaRow: { flexDirection: 'row', alignItems: 'center', gap: 6 },
  durWrap: { flexDirection: 'row', alignItems: 'center', gap: 3 },
  durText: { fontFamily: 'Farro-Regular', fontSize: 11, color: THEME.FG3 },
  catWrap: { backgroundColor: '#f3f4f6', paddingVertical: 1, paddingHorizontal: 6, borderRadius: 4 },
  ...
  progBarBg: { flex: 1, height: 3, backgroundColor: '#f3f4f6', borderRadius: 999, overflow: 'hidden' },
  ...
  actionBtnStart: { backgroundColor: THEME.P, shadowColor: THEME.P, shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.5, shadowRadius: 8, elevation: 2 },
