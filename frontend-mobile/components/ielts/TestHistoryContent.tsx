...
export function TestHistoryContent({ embedded = false }: { embedded?: boolean }) {
  ...
  const content = (
    <View style={{ flex: 1, backgroundColor: colors.background }}>
      {/* ── Embedded segment header or Full Header ── */}
      {!embedded ? (
        <View
          style={{
        ...
        <View style={{ paddingHorizontal: SPACING.lg, paddingTop: SPACING.md, paddingBottom: SPACING.xs, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
          <Text style={{ fontFamily: FONTS.bold, fontSize: 14, color: colors.textSecondary }} allowFontScaling={true}>
            Total records: {displayed.length}/{totalForMode}
          </Text>
        </View>
      )}
      ...
      >
        <FlatList
          ...
          contentContainerStyle={{ padding: SPACING.lg, paddingBottom: embedded ? 40 : 120 }}
