        ...
        <ScrollView contentContainerStyle={styles.prepScroll} showsVerticalScrollIndicator={false}>
          <View style={styles.prepTitleSection}>
            <View style={[styles.prepCamBadge, { backgroundColor: colors.primary + '20' }]}>
              ...
              <Text style={[styles.prepCamBadgeText, { color: colors.primary }]}>
                Cambridge IELTS
              </Text>
            </View>
            <Text style={[styles.prepGroupTitle, { color: colors.text }]}>{groupTitle}</Text>
            {testTitle ? (
              <Text style={[styles.prepTestTitle, { color: colors.textSecondary }]}>
                {testTitle}
              </Text>
            ) : null}
            <View style={styles.prepDecorRow}>
              ...
              <View
                style={[
                  styles.prepDecorBar,
                  { width: 12, backgroundColor: isDark ? colors.border : '#D1D5DB' },
                ]}
              />
              <View
                style={[
                  styles.prepDecorBar,
                  { width: 12, backgroundColor: isDark ? colors.border + '60' : '#E5E7EB' },
                ]}
              />
            </View>
          </View>
          ...
          <View
            style={[styles.prepCard, { backgroundColor: colors.card, borderColor: colors.border }]}
          >
            <View style={styles.prepCardLeft}>
              <Text style={[styles.prepSectionLabel, { color: colors.textSecondary }]}>
                Exam Details
              </Text>

              <View
                style={[
                  styles.prepDetailRow,
              ...
              >
                ...
                <View>
                  <Text style={[styles.prepDetailMeta, { color: colors.textSecondary }]}>
                    Duration
                  </Text>
              ...
              <View
                style={[
                  styles.prepNoticeBox,
                  { backgroundColor: colors.surface, borderColor: colors.border },
                ]}
              >
                <Text style={[styles.prepNoticeText, { color: colors.textSecondary }]}>
                  {noticeText}
                </Text>
              </View>
            </View>
            ...
            <View style={styles.prepCardRight}>
              ...
              {videoId ? (
                <>
                  ...
                  <Text style={[styles.prepVideoCaption, { color: colors.textSecondary }]}>
                    Watch the full tutorial before attempting the test to familiarise yourself with
                    the format.
                  </Text>
                </>
              ) : (
              ...
              <View style={styles.prepChipRow}>
                {chips.map((chip) => (
                  ...
                  >
                    <Text style={[styles.prepChipText, { color: colors.textSecondary }]}>
                      {chip}
                    </Text>
                  </View>
                ))}
...
const createPrepStyles = (colors: any, isDark: boolean) =>
  StyleSheet.create({
