...
\begin{figure*}[!t]
\centerline{\includegraphics[width=\textwidth]{figure_2_entity_relationship_diagram_key_entities.png}}
...
\begin{figure}[!t]
\centerline{\includegraphics[height=9cm,keepaspectratio]{sm2_algorithm_flowchart.png}}
...
\begin{figure}[!t]
\centerline{\includegraphics[height=9cm,keepaspectratio]{figure_4_deployment_architecture.png}}
...
The platform provides interfaces for: IELTS Hub (4-stage learning journey), exam practice, AI grading results with detailed feedback, Vocab Lab flashcards, pronunciation checker, shadowing/dictation, and grammar lessons. Fig.~\ref{fig:ui_roadmap} shows the personalized learning roadmap, and Fig.~\ref{fig:ui_grading} demonstrates the AI Writing grading interface.

\begin{figure}[!t]
\centerline{\includegraphics[width=\columnwidth]{ui_roadmap.png}}
\caption{Personalized IELTS Basic Mastery Roadmap with sequential day-based learning steps, progress tracking, and step-level locking.}
\label{fig:ui_roadmap}
\end{figure}

\begin{figure}[!t]
\centerline{\includegraphics[width=\columnwidth]{ui_writing_grading.png}}
\caption{AI Writing grading interface showing per-criterion band scores, identified strengths and weaknesses, improvement suggestions, and annotated corrections.}
\label{fig:ui_grading}
\end{figure}
...
Fig.~\ref{fig:sm2_interval} presents the interval progression across the three user profiles.

\begin{figure}[!t]
\centerline{\includegraphics[width=\columnwidth]{sm2_interval_progression.png}}
...
User~A (46/50 correct) achieves exponential interval growth, reaching a final interval of 17~days, a maximum of 74,922~days, and entering the REVIEW state 41/50 times. User~B (28/50 correct) reaches a final interval of 12~days with a maximum of 14~days and 15 REVIEW entries. User~C (20/50 correct) remains at a final interval of 1~day with a maximum of 9~days and only 8 REVIEW entries. All ease factors decline from the initial 2.5, with Users~A and~B stabilizing at 1.50 and User~C converging to 1.40 near the minimum bound. Table~\ref{tab:sm2_summary} provides a quantitative summary.

\begin{table}[!t]
\caption{SM-2 Simulation Summary ($N=50$ Reviews)}
\label{tab:sm2_summary}
\centering
\begin{tabular}{lccc}
\toprule
...
\midrule
Accuracy & 90\% & 60\% & 30\% \\
Correct Responses & 46 & 28 & 20 \\
Final Ease Factor & 1.50 & 1.50 & 1.40 \\
Final Interval (days) & 17 & 12 & 1 \\
Max Interval (days) & 74,922 & 14 & 9 \\
Times in REVIEW & 41 & 15 & 8 \\
\bottomrule
\end{tabular}
\end{table}
...
51 pronunciation attempt pairs were tested across three difficulty levels. The results are presented in Fig.~\ref{fig:pron_dist} and Fig.~\ref{fig:pron_edit}.

\begin{figure}[!t]
\centerline{\includegraphics[width=\columnwidth]{pronunciation_score_distribution.png}}
...
\begin{figure}[!t]
\centerline{\includegraphics[width=\columnwidth]{pronunciation_edit_distance.png}}
